      ...
      try {
        ...
        if (keywordData.error) {
          ...
          if (body.salary !== null) {
            ...
            body.salary = body.salary.replace(/\£/g, "");
            body.salary = body.salary.replace(/\€/g, "");
            if (body.salary === 'Competitive' || body.salary === 'Dependsonthecompany' || body.salary === 'Dependsonspecificcompanyandrole') {
              body.salary = null;
            }
          }
            ...
            <div className="content__container__content__under_entry">
              <ul style={{ listStyleType: 'none' }}>
                ...
                <li style={{ paddingTop: '25px' }}>
                  <div className="content__container__content__under_entry">
                    <img src={`data:image/png;base64, ${searchData.image}`} alt="Red dot" style={{ height: '285px', width: '600px' }} />
